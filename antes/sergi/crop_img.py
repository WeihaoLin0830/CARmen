...
if __name__ == "__main__":
    ...
    try:
        ...
        retrieval, image_contexts = retrieve_context(
        ...
        scores = rank_similar_images(cropped, top_k=1, image_paths_list=retrieval)
        ...
        # Ensure top_pages is defined
        top_pages = [ctx["start_page"] for ctx in retrieval[:len(scores)]]
