...
def extract_content_from_pdf(pdf_path, output_dir="extracted_content"):
    ...
    if not os.path.isfile(pdf_path):
        raise FileNotFoundError(f"The file '{pdf_path}' does not exist. Please provide a valid path to a PDF file.")
    
    # Check if the file is a PDF
    if not pdf_path.lower().endswith('.pdf'):
        raise ValueError(f"The file '{pdf_path}' does not appear to be a PDF. Please provide a PDF file.")
